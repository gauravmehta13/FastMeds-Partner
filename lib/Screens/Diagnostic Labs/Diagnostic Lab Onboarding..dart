...
class DiagnosticLabOnBoarding extends StatefulWidget {
  final edit;
  DiagnosticLabOnBoarding({this.edit});
  @override
  _DiagnosticLabOnBoardingState createState() =>
      _DiagnosticLabOnBoardingState();
}

class _DiagnosticLabOnBoardingState extends State<DiagnosticLabOnBoarding> {
  ...
  void initState() {
    ...
    DatabaseService(_auth.currentUser!.uid).updateDiagnosticLabData(
        "", "", "", "", "", "", "", "", "", "", "", "", "", 0, 0);
    getLocation();
  }
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                                ...
                                child: Center(
                                  child: Text(
                                    "85% customers prefer to select a Diagnostic Lab with complete details.",
